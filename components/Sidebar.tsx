            ...
            <li key={item.id}>
              {item.isExternal ? (
                <a
                  ...
                  className={`w-full flex items-center ${isCollapsed ? 'justify-center px-0 py-3' : 'px-3 py-2'} rounded-md text-sm font-medium transition-colors text-gray-300 hover:bg-gray-700 hover:text-white`}
                ...
                <button
                  ...
                  className={`w-full flex items-center ${isCollapsed ? 'justify-center px-0 py-3' : 'px-3 py-2'} rounded-md text-sm font-medium transition-colors ${
                    activeView === item.id
